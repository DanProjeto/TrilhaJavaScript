...
// prototype que é um recurso do Javascript que possibilita modificar uma classe depois de que ela for criada
...
listButton.prototype.objButton_OnClick = function (objPosition) {
    if (!this.isOpen) {
        ...
        /* offsetTop - Método de apenas leitura que vai retornar a medida em pixels da distância
            do elemento atual em relação ao topo do elemento height */
        this.objDiv.style.top = (objPosition.offsetTop + parseInt(this.height));
        /* offsetLeft - Método de apenas leitura que vai retornar a medida em pixels da distância
            do canto superior esquerdo do elemento atual, que nesse caso será o objDiv */
...
listButton.prototype.createButton = function (objRecipient) {
    ...
    // createElement vai criar um botão (input) e adicionar no elemento body da página
