var curiosidades_chuck_norris = [{
	...
	conteudo: "Chuck Norris pode assistir um episódio de 60 minutos em 22 segundos."
}, {
	...
	conteudo: "Chuck Norris faz cebolas chorarem."
}, {
...
// Math.rando() - Retorna um número aleatório entre 0 e < 1
/* Math.floor() - Arredonda um número para baixo para o número inteiro
   mais próximo */
var numero_sorteado = Math.floor(Math.random() * tamanho_colecao);

/* A variável numero_sorteado é utilizado como índice na coleção,
   o que permite o acesso a um objeto dentro do array */
