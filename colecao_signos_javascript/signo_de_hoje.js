...
const verificar_intervalo_datas = (data, data_inicio, data_fim, tipo_comparacao) => {
...
const retornar_signo = (signos, data) => {
	...
	for (const signo of signos) {
		...
		if (verificar_intervalo_datas(data, data_inicio_signo, data_fim_signo, tipo_comparacao)) {
			return signo["Nome"];
		}
	}
}
...
const nome_signo = retornar_signo(colecao_signos, data_app);
